...
<div class="efs-typography efs-admin-wrap">
	...
	<?php if ( ! $is_bricks_site && ! $is_etch_site ) : ?>
		<div class="efs-card efs-card--warning">
			...
			<p><?php esc_html_e( 'Etch Fusion Suite requires either Bricks Builder or Etch running on the source site.', 'etch-fusion-suite' ); ?></p>
			<ul class="efs-list">
				<li><?php esc_html_e( 'Install and activate Bricks Builder on the source WordPress site.', 'etch-fusion-suite' ); ?></li>
				<li><?php esc_html_e( 'Install and activate Etch on the target WordPress site.', 'etch-fusion-suite' ); ?></li>
			</ul>
			<p>
