...
$etch_fusion_suite_key_args = is_array( $migration_key_args ) ? $migration_key_args : array();
...
<section class="efs-card efs-card--source efs-accordion" data-efs-accordion>
			...
			<?php foreach ( $etch_fusion_suite_sections as $etch_fusion_suite_section_key => $etch_fusion_suite_section_config ) : ?>
				...
				<section class="efs-accordion__section<?php echo $etch_fusion_suite_section_open ? ' is-expanded' : ''; ?>" data-efs-accordion-section data-section="<?php echo esc_attr( $etch_fusion_suite_section_key ); ?>">
					...
					>
						<?php if ( 'connection' === $etch_fusion_suite_section_config['content'] ) : ?>
						...
						<?php elseif ( 'migration_key' === $etch_fusion_suite_section_config['content'] ) : ?>
							...
							$etch_fusion_suite_component_config   = wp_parse_args( $etch_fusion_suite_key_args, $etch_fusion_suite_component_defaults );
							(
								static function ( $component_args ) {
						...
						<?php elseif ( 'migration' === $etch_fusion_suite_section_config['content'] ) : ?>
