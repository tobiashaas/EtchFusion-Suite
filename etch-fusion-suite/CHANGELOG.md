...
- **Security: `efs_headless_job_count` added to uninstall cleanup (2026-03-06):** The new diagnostic option was missing from the uninstall cleanup list in `db-installer.php`.
